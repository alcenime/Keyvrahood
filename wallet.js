...
(function () {
  ...
  function refreshBalances() {
    ...
    Object.keys(TOKENS).forEach(function (key) {
      ...
      jobs.push(
        (t.decimals !== null ? Promise.resolve(t.decimals) : erc20Decimals(t.address))
          .then(function (decimals) {
            return erc20BalanceOf(t.address, state.address).then(function (hex) {
              state.balances[key] = hexToEtherString(hex, decimals);
            });
          })
          .catch(function (e) {
            console.error('[KeyvraWallet] Failed to fetch ' + t.symbol + ' balance:', e);
